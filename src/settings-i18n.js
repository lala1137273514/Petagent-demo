...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      glassboxTabTitle: "Glass-box Voice",
      glassboxTabDesc: "Switches and parameters for voice-controlling the desktop pet. Empty = use environment variable / built-in default. Changes apply instantly (hotkey needs a restart). Launch with CLAWD_GLASSBOX_VOICE=1.",
      glassboxVoiceEnabled: "Voice master switch",
      glassboxVoiceEnabledDesc: "Turn the whole glass-box voice pipeline on or off.",
      glassboxWakeWord: "Wake word “hey, cc”",
      glassboxWakeWordDesc: "Listen for the wake word so you can talk without pressing the hotkey.",
      glassboxConfirmMode: "Execution confirmation",
      glassboxConfirmModeDesc: "Whether the pet asks before assigning work. Agent tool approvals stay native/default.",
      glassboxConfirmAgentNative: "Agent native",
      glassboxConfirmAlways: "Before every dispatch",
      glassboxConfirmWritesOnly: "Writes only",
      glassboxDispatchBackendScript: "Visible Terminal script",
      glassboxDispatchBackendAgent: "Background agent CLI",
      glassboxPermissionMode: "Dispatch permission mode",
      glassboxPermissionModeDesc: "How much the dispatched agent is allowed to do on its own.",
      glassboxPermissionFollowEnv: "Follow env var (default)",
      glassboxPermissionBypass: "Bypass (allow all)",
      glassboxPermissionAcceptEdits: "Accept edits",
      glassboxPermissionPlan: "Plan only",
      glassboxPermissionDefault: "Default (ask each)",
      glassboxOrchModel: "Chat model",
      glassboxOrchModelDesc: "Model that plans and dispatches voice commands.",
      glassboxOrchModelPlaceholder: "Empty = default qwen-plus",
      glassboxOrchApiUrl: "Chat API URL",
      glassboxOrchApiUrlDesc: "OpenAI-compatible chat completions URL used by the voice orchestrator.",
      glassboxOrchApiUrlPlaceholder: "Empty = DashScope compatible endpoint",
      glassboxOrchApiKey: "Bailian API key",
      glassboxOrchApiKeyDesc: "Shared local key for chat, TTS and ASR. Stored in plaintext prefs; env vars are safer.",
      glassboxOrchApiKeyPlaceholder: "Empty = BAILIAN_API_KEY / DASHSCOPE_API_KEY",
      glassboxTtsModel: "TTS model",
      glassboxTtsModelDesc: "Model used for spoken replies.",
      glassboxTtsModelPlaceholder: "Empty = qwen3-tts-flash",
      glassboxTtsApiUrl: "TTS API URL",
      glassboxTtsApiUrlDesc: "DashScope TTS generation endpoint.",
      glassboxTtsApiUrlPlaceholder: "Empty = DashScope TTS endpoint",
      glassboxTtsVoice: "TTS voice",
      glassboxTtsVoiceDesc: "Voice used for spoken replies.",
      glassboxTtsVoicePlaceholder: "Empty = default Cherry",
      glassboxTtsEventStart: "Speak on start",
      glassboxTtsEventStartDesc: "Play TTS when a run starts.",
      glassboxTtsEventFanout: "Speak on parallel work",
      glassboxTtsEventFanoutDesc: "Play TTS when multiple agents/subtasks fan out.",
      glassboxTtsEventStuck: "Speak on stuck/error",
      glassboxTtsEventStuckDesc: "Play TTS when the run appears blocked or interrupted.",
      glassboxTtsEventDone: "Speak on completion",
      glassboxTtsEventDoneDesc: "Play TTS when the run finishes.",
      glassboxAsrModel: "ASR model",
      glassboxAsrModelDesc: "Speech-recognition model. Current runtime uses the local ASR adapter.",
      glassboxAsrModelPlaceholder: "Empty = local small",
      glassboxAsrApiUrl: "ASR API URL",
      glassboxAsrApiUrlDesc: "Remote ASR endpoint override, reserved for the ASR adapter.",
      glassboxAsrApiUrlPlaceholder: "Empty = local ASR",
      glassboxWhisperModel: "Whisper model",
      glassboxWhisperModelDesc: "Speech-recognition model size. Larger = more accurate but slower.",
      glassboxWhisperFollowEnv: "Follow env var (base)",
      glassboxWhisperTiny: "tiny (fastest)",
      glassboxWhisperBase: "base",
      glassboxWhisperSmall: "small",
      glassboxWhisperMedium: "medium",
      glassboxWhisperLarge: "large (most accurate)",
      glassboxHotkey: "Activation hotkey",
      glassboxHotkeyDesc: "Global shortcut to start listening. Takes effect after restart.",
      glassboxHotkeyPlaceholder: "Empty = Ctrl+Space",
      glassboxSystemPrompt: "System prompt",
      glassboxSystemPromptDesc: "Override the built-in voice system prompt.",
      glassboxSystemPromptPlaceholder: "Empty = use built-in prompt file",
    ...
    zh: {
      ...
      glassboxTabTitle: "玻璃盒语音",
      glassboxTabDesc: "桌宠语音遥控的开关与参数。留空 = 用环境变量 / 内置默认；改动即时生效（热键需重启）。需以 CLAWD_GLASSBOX_VOICE=1 启动。",
      glassboxVoiceEnabled: "语音总开关",
      glassboxVoiceEnabledDesc: "打开或关闭整个玻璃盒语音链路。",
      glassboxWakeWord: "唤醒词「hey, cc」",
      glassboxWakeWordDesc: "听到唤醒词就开始识别，不用按热键。",
      glassboxConfirmMode: "执行确认策略",
      glassboxConfirmModeDesc: "桌宠派活前是否额外询问；agent 工具权限交给原生 / 默认流程。",
      glassboxConfirmAgentNative: "交给 agent 原生确认",
      glassboxConfirmAlways: "每次派活前确认",
      glassboxConfirmWritesOnly: "仅写操作",
      glassboxDispatchBackendScript: "可见终端脚本（Demo）",
      glassboxDispatchBackendAgent: "后台 Agent CLI",
      glassboxPermissionMode: "派发权限模式",
      glassboxPermissionModeDesc: "派发的 agent 可以自主做多少。",
      glassboxPermissionFollowEnv: "跟随环境变量（默认）",
      glassboxPermissionBypass: "全部放行（bypass）",
      glassboxPermissionAcceptEdits: "自动接受编辑",
      glassboxPermissionPlan: "仅规划",
      glassboxPermissionDefault: "默认（逐项询问）",
      glassboxOrchModel: "对话模型",
      glassboxOrchModelDesc: "负责规划和派发语音指令的模型。",
      glassboxOrchModelPlaceholder: "留空 = 默认 qwen-plus",
      glassboxOrchApiUrl: "对话 API 地址",
      glassboxOrchApiUrlDesc: "语音编排器使用的 OpenAI 兼容 chat completions 地址。",
      glassboxOrchApiUrlPlaceholder: "留空 = DashScope 兼容端点",
      glassboxOrchApiKey: "百炼 API 密钥",
      glassboxOrchApiKeyDesc: "对话、TTS、ASR 共用的本地密钥。会明文保存到 prefs；环境变量更安全。",
      glassboxOrchApiKeyPlaceholder: "留空 = BAILIAN_API_KEY / DASHSCOPE_API_KEY",
      glassboxTtsModel: "TTS 模型",
      glassboxTtsModelDesc: "语音播报使用的模型。",
      glassboxTtsModelPlaceholder: "留空 = qwen3-tts-flash",
      glassboxTtsApiUrl: "TTS API 地址",
      glassboxTtsApiUrlDesc: "DashScope TTS 生成接口地址。",
      glassboxTtsApiUrlPlaceholder: "留空 = DashScope TTS 端点",
      glassboxTtsVoice: "语音音色（TTS）",
      glassboxTtsVoiceDesc: "语音回复使用的音色。",
      glassboxTtsVoicePlaceholder: "留空 = 默认 Cherry",
      glassboxTtsEventStart: "开始时播报",
      glassboxTtsEventStartDesc: "任务开始时播放 TTS。",
      glassboxTtsEventFanout: "并行时播报",
      glassboxTtsEventFanoutDesc: "出现多个 agent / 子任务并行时播放 TTS。",
      glassboxTtsEventStuck: "卡住时播报",
      glassboxTtsEventStuckDesc: "任务卡住或中断时播放 TTS。",
      glassboxTtsEventDone: "完成时播报",
      glassboxTtsEventDoneDesc: "任务完成时播放 TTS。",
      glassboxAsrModel: "ASR 模型",
      glassboxAsrModelDesc: "语音识别使用的模型；配置 API 地址后走百炼实时 ASR。",
      glassboxAsrModelPlaceholder: "留空 = paraformer-realtime-v2",
      glassboxAsrApiUrl: "ASR API 地址",
      glassboxAsrApiUrlDesc: "百炼/DashScope 实时 ASR WebSocket 地址。",
      glassboxAsrApiUrlPlaceholder: "留空 = DashScope ASR 端点",
      glassboxWhisperModel: "Whisper 识别模型",
      glassboxWhisperModelDesc: "语音识别模型大小；越大越准但越慢。",
      glassboxWhisperFollowEnv: "跟随环境变量（base）",
      glassboxWhisperTiny: "tiny（最快）",
      glassboxWhisperBase: "base",
      glassboxWhisperSmall: "small",
      glassboxWhisperMedium: "medium",
      glassboxWhisperLarge: "large（最准）",
      glassboxHotkey: "呼出快捷键",
      glassboxHotkeyDesc: "全局唤醒快捷键，重启后生效。",
      glassboxHotkeyPlaceholder: "留空 = Ctrl+Space",
      glassboxSystemPrompt: "系统提示词",
      glassboxSystemPromptDesc: "覆盖内置的语音系统提示词。",
      glassboxSystemPromptPlaceholder: "留空 = 用内置提示词文件",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
    ...
    "zh-TW": {
      ...
      glassboxTabTitle: "玻璃盒語音",
      glassboxTabDesc: "桌寵語音遙控的開關與參數。留空 = 用環境變數 / 內建預設；變動即時生效（熱鍵需重啟）。需以 CLAWD_GLASSBOX_VOICE=1 啟動。",
      glassboxVoiceEnabled: "語音總開關",
      glassboxVoiceEnabledDesc: "打開或關閉整個玻璃盒語音鏈路。",
      glassboxWakeWord: "喚醒詞「hey, cc」",
      glassboxWakeWordDesc: "聽到喚醒詞就開始辨識，不用按熱鍵。",
      glassboxConfirmMode: "執行確認策略",
      glassboxConfirmModeDesc: "桌寵派活前是否額外詢問；agent 工具權限交給原生 / 預設流程。",
      glassboxConfirmAgentNative: "交給 agent 原生確認",
      glassboxConfirmAlways: "每次派活前確認",
      glassboxConfirmWritesOnly: "僅寫操作",
      glassboxDispatchBackendScript: "可見終端腳本（Demo）",
      glassboxDispatchBackendAgent: "背景 Agent CLI",
      glassboxPermissionMode: "派發權限模式",
      glassboxPermissionModeDesc: "派發的 agent 可以自主做多少。",
      glassboxPermissionFollowEnv: "跟隨環境變數（預設）",
      glassboxPermissionBypass: "全部放行（bypass）",
      glassboxPermissionAcceptEdits: "自動接受編輯",
      glassboxPermissionPlan: "僅規劃",
      glassboxPermissionDefault: "預設（逐項詢問）",
      glassboxOrchModel: "對話模型",
      glassboxOrchModelDesc: "負責規劃和派發語音指令的模型。",
      glassboxOrchModelPlaceholder: "留空 = 預設 qwen-plus",
      glassboxOrchApiUrl: "對話 API 地址",
      glassboxOrchApiUrlDesc: "語音編排器使用的 OpenAI 相容 chat completions 地址。",
      glassboxOrchApiUrlPlaceholder: "留空 = DashScope 相容端點",
      glassboxOrchApiKey: "百煉 API 金鑰",
      glassboxOrchApiKeyDesc: "對話、TTS、ASR 共用的本機金鑰。會明文儲存到 prefs；環境變數更安全。",
      glassboxOrchApiKeyPlaceholder: "留空 = BAILIAN_API_KEY / DASHSCOPE_API_KEY",
      glassboxTtsModel: "TTS 模型",
      glassboxTtsModelDesc: "語音播報使用的模型。",
      glassboxTtsModelPlaceholder: "留空 = qwen3-tts-flash",
      glassboxTtsApiUrl: "TTS API 地址",
      glassboxTtsApiUrlDesc: "DashScope TTS 生成介面地址。",
      glassboxTtsApiUrlPlaceholder: "留空 = DashScope TTS 端點",
      glassboxTtsVoice: "語音音色（TTS）",
      glassboxTtsVoiceDesc: "語音回覆使用的音色。",
      glassboxTtsVoicePlaceholder: "留空 = 預設 Cherry",
      glassboxTtsEventStart: "開始時播報",
      glassboxTtsEventStartDesc: "任務開始時播放 TTS。",
      glassboxTtsEventFanout: "並行時播報",
      glassboxTtsEventFanoutDesc: "出現多個 agent / 子任務並行時播放 TTS。",
      glassboxTtsEventStuck: "卡住時播報",
      glassboxTtsEventStuckDesc: "任務卡住或中斷時播放 TTS。",
      glassboxTtsEventDone: "完成時播報",
      glassboxTtsEventDoneDesc: "任務完成時播放 TTS。",
      glassboxAsrModel: "ASR 模型",
      glassboxAsrModelDesc: "語音辨識使用的模型；設定 API 地址後走百煉即時 ASR。",
      glassboxAsrModelPlaceholder: "留空 = paraformer-realtime-v2",
      glassboxAsrApiUrl: "ASR API 地址",
      glassboxAsrApiUrlDesc: "百煉 / DashScope 即時 ASR WebSocket 地址。",
      glassboxAsrApiUrlPlaceholder: "留空 = DashScope ASR 端點",
      glassboxWhisperModel: "Whisper 辨識模型",
      glassboxWhisperModelDesc: "語音辨識模型大小；越大越準但越慢。",
      glassboxWhisperFollowEnv: "跟隨環境變數（base）",
      glassboxWhisperTiny: "tiny（最快）",
      glassboxWhisperBase: "base",
      glassboxWhisperSmall: "small",
      glassboxWhisperMedium: "medium",
      glassboxWhisperLarge: "large（最準）",
      glassboxHotkey: "呼出快捷鍵",
      glassboxHotkeyDesc: "全域喚醒快捷鍵，重啟後生效。",
      glassboxHotkeyPlaceholder: "留空 = Ctrl+Space",
      glassboxSystemPrompt: "系統提示詞",
      glassboxSystemPromptDesc: "覆蓋內建的語音系統提示詞。",
      glassboxSystemPromptPlaceholder: "留空 = 用內建提示詞檔案",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
    ...
    ko: {
      ...
      glassboxTabTitle: "글래스박스 음성",
      glassboxTabDesc: "데스크 펫을 음성으로 원격 제어하는 스위치와 매개변수. 비우면 환경 변수 / 기본값 사용. 변경은 즉시 적용됩니다(단축키는 재시작 필요). CLAWD_GLASSBOX_VOICE=1로 실행하세요.",
      glassboxVoiceEnabled: "음성 마스터 스위치",
      glassboxVoiceEnabledDesc: "글래스박스 음성 파이프라인 전체를 켜거나 끕니다.",
      glassboxWakeWord: "호출어 “hey, cc”",
      glassboxWakeWordDesc: "호출어를 듣고 시작하므로 단축키 없이 말할 수 있습니다.",
      glassboxConfirmMode: "실행 확인 정책",
      glassboxConfirmModeDesc: "펫이 작업을 맡기기 전에 추가로 물어볼지 여부. 에이전트 도구 승인은 기본/네이티브 흐름에 맡깁니다.",
      glassboxConfirmAgentNative: "에이전트 네이티브 확인",
      glassboxConfirmAlways: "매번 디스패치 전 확인",
      glassboxConfirmWritesOnly: "쓰기만",
      glassboxPermissionMode: "디스패치 권한 모드",
      glassboxPermissionModeDesc: "디스패치된 에이전트가 스스로 할 수 있는 범위.",
      glassboxPermissionFollowEnv: "환경 변수 따름(기본)",
      glassboxPermissionBypass: "모두 허용(bypass)",
      glassboxPermissionAcceptEdits: "편집 자동 수락",
      glassboxPermissionPlan: "계획만",
      glassboxPermissionDefault: "기본(항목별 문의)",
      glassboxOrchModel: "채팅 모델",
      glassboxOrchModelDesc: "음성 명령을 계획하고 디스패치하는 모델.",
      glassboxOrchModelPlaceholder: "비우면 = 기본 qwen-plus",
      glassboxOrchApiUrl: "채팅 API URL",
      glassboxOrchApiUrlDesc: "음성 오케스트레이터가 사용하는 OpenAI 호환 chat completions URL.",
      glassboxOrchApiUrlPlaceholder: "비우면 = DashScope 호환 엔드포인트",
      glassboxOrchApiKey: "Bailian API 키",
      glassboxOrchApiKeyDesc: "채팅, TTS, ASR이 함께 쓰는 로컬 키. 일반 prefs에 저장되므로 환경 변수가 더 안전합니다.",
      glassboxOrchApiKeyPlaceholder: "비우면 = BAILIAN_API_KEY / DASHSCOPE_API_KEY",
      glassboxTtsModel: "TTS 모델",
      glassboxTtsModelDesc: "음성 안내에 사용하는 모델.",
      glassboxTtsModelPlaceholder: "비우면 = qwen3-tts-flash",
      glassboxTtsApiUrl: "TTS API URL",
      glassboxTtsApiUrlDesc: "DashScope TTS 생성 엔드포인트.",
      glassboxTtsApiUrlPlaceholder: "비우면 = DashScope TTS 엔드포인트",
      glassboxTtsVoice: "음성(TTS)",
      glassboxTtsVoiceDesc: "음성 응답에 사용하는 목소리.",
      glassboxTtsVoicePlaceholder: "비우면 = 기본 Cherry",
      glassboxTtsEventStart: "시작 시 말하기",
      glassboxTtsEventStartDesc: "작업이 시작될 때 TTS를 재생합니다.",
      glassboxTtsEventFanout: "병렬 작업 시 말하기",
      glassboxTtsEventFanoutDesc: "여러 에이전트/하위 작업이 병렬로 진행될 때 TTS를 재생합니다.",
      glassboxTtsEventStuck: "막힘/오류 시 말하기",
      glassboxTtsEventStuckDesc: "작업이 막히거나 중단된 것처럼 보일 때 TTS를 재생합니다.",
      glassboxTtsEventDone: "완료 시 말하기",
      glassboxTtsEventDoneDesc: "작업이 끝나면 TTS를 재생합니다.",
      glassboxAsrModel: "ASR 모델",
      glassboxAsrModelDesc: "음성 인식 모델. API URL을 설정하면 Bailian 실시간 ASR을 사용합니다.",
      glassboxAsrModelPlaceholder: "비우면 = paraformer-realtime-v2",
      glassboxAsrApiUrl: "ASR API URL",
      glassboxAsrApiUrlDesc: "Bailian/DashScope 실시간 ASR WebSocket URL.",
      glassboxAsrApiUrlPlaceholder: "비우면 = DashScope ASR 엔드포인트",
      glassboxWhisperModel: "Whisper 인식 모델",
      glassboxWhisperModelDesc: "음성 인식 모델 크기. 클수록 정확하지만 느립니다.",
      glassboxWhisperFollowEnv: "환경 변수 따름(base)",
      glassboxWhisperTiny: "tiny(가장 빠름)",
      glassboxWhisperBase: "base",
      glassboxWhisperSmall: "small",
      glassboxWhisperMedium: "medium",
      glassboxWhisperLarge: "large(가장 정확)",
      glassboxHotkey: "호출 단축키",
      glassboxHotkeyDesc: "듣기 시작 전역 단축키. 재시작 후 적용됩니다.",
      glassboxHotkeyPlaceholder: "비우면 = Ctrl+Space",
      glassboxSystemPrompt: "시스템 프롬프트",
      glassboxSystemPromptDesc: "내장 음성 시스템 프롬프트를 재정의합니다.",
      glassboxSystemPromptPlaceholder: "비우면 = 내장 프롬프트 파일 사용",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
    ...
    ja: {
      ...
      glassboxTabTitle: "グラスボックス音声",
      glassboxTabDesc: "デスクペットを音声で遠隔操作するスイッチとパラメータ。空欄 = 環境変数 / 組み込みの既定値。変更は即座に適用（ホットキーは再起動が必要）。CLAWD_GLASSBOX_VOICE=1 で起動してください。",
      glassboxVoiceEnabled: "音声マスタースイッチ",
      glassboxVoiceEnabledDesc: "グラスボックス音声パイプライン全体をオン / オフにします。",
      glassboxWakeWord: "ウェイクワード「hey, cc」",
      glassboxWakeWordDesc: "ウェイクワードを聴取してホットキーなしで話せます。",
      glassboxConfirmMode: "実行確認ポリシー",
      glassboxConfirmModeDesc: "ペットが作業を割り当てる前に追加確認するかどうか。エージェントのツール承認はネイティブ / 既定フローに任せます。",
      glassboxConfirmAgentNative: "エージェントのネイティブ確認",
      glassboxConfirmAlways: "毎回ディスパッチ前に確認",
      glassboxConfirmWritesOnly: "書き込みのみ",
      glassboxPermissionMode: "ディスパッチ権限モード",
      glassboxPermissionModeDesc: "ディスパッチされたエージェントが自律的にできる範囲。",
      glassboxPermissionFollowEnv: "環境変数に従う（既定）",
      glassboxPermissionBypass: "すべて許可（bypass）",
      glassboxPermissionAcceptEdits: "編集を自動受諾",
      glassboxPermissionPlan: "計画のみ",
      glassboxPermissionDefault: "既定（都度確認）",
      glassboxOrchModel: "チャットモデル",
      glassboxOrchModelDesc: "音声コマンドを計画・ディスパッチするモデル。",
      glassboxOrchModelPlaceholder: "空欄 = 既定 qwen-plus",
      glassboxOrchApiUrl: "チャット API URL",
      glassboxOrchApiUrlDesc: "音声オーケストレーターが使う OpenAI 互換 chat completions URL。",
      glassboxOrchApiUrlPlaceholder: "空欄 = DashScope 互換エンドポイント",
      glassboxOrchApiKey: "Bailian API キー",
      glassboxOrchApiKeyDesc: "チャット、TTS、ASR で共有するローカルキー。平文 prefs に保存されるため、環境変数の方が安全です。",
      glassboxOrchApiKeyPlaceholder: "空欄 = BAILIAN_API_KEY / DASHSCOPE_API_KEY",
      glassboxTtsModel: "TTS モデル",
      glassboxTtsModelDesc: "音声読み上げに使うモデル。",
      glassboxTtsModelPlaceholder: "空欄 = qwen3-tts-flash",
      glassboxTtsApiUrl: "TTS API URL",
      glassboxTtsApiUrlDesc: "DashScope TTS 生成エンドポイント。",
      glassboxTtsApiUrlPlaceholder: "空欄 = DashScope TTS エンドポイント",
      glassboxTtsVoice: "音声（TTS）",
      glassboxTtsVoiceDesc: "音声応答に使う声。",
      glassboxTtsVoicePlaceholder: "空欄 = 既定 Cherry",
      glassboxTtsEventStart: "開始時に読み上げ",
      glassboxTtsEventStartDesc: "実行開始時に TTS を再生します。",
      glassboxTtsEventFanout: "並列作業時に読み上げ",
      glassboxTtsEventFanoutDesc: "複数のエージェント / サブタスクへ分岐したときに TTS を再生します。",
      glassboxTtsEventStuck: "停滞 / エラー時に読み上げ",
      glassboxTtsEventStuckDesc: "実行が詰まった、または中断されたように見えるときに TTS を再生します。",
      glassboxTtsEventDone: "完了時に読み上げ",
      glassboxTtsEventDoneDesc: "実行完了時に TTS を再生します。",
      glassboxAsrModel: "ASR モデル",
      glassboxAsrModelDesc: "音声認識モデル。API URL を設定すると Bailian リアルタイム ASR を使います。",
      glassboxAsrModelPlaceholder: "空欄 = paraformer-realtime-v2",
      glassboxAsrApiUrl: "ASR API URL",
      glassboxAsrApiUrlDesc: "Bailian / DashScope リアルタイム ASR WebSocket URL。",
      glassboxAsrApiUrlPlaceholder: "空欄 = DashScope ASR エンドポイント",
      glassboxWhisperModel: "Whisper 認識モデル",
      glassboxWhisperModelDesc: "音声認識モデルのサイズ。大きいほど正確だが遅い。",
      glassboxWhisperFollowEnv: "環境変数に従う（base）",
      glassboxWhisperTiny: "tiny（最速）",
      glassboxWhisperBase: "base",
      glassboxWhisperSmall: "small",
      glassboxWhisperMedium: "medium",
      glassboxWhisperLarge: "large（最も正確）",
      glassboxHotkey: "呼び出しホットキー",
      glassboxHotkeyDesc: "聴取開始のグローバルショートカット。再起動後に適用。",
      glassboxHotkeyPlaceholder: "空欄 = Ctrl+Space",
      glassboxSystemPrompt: "システムプロンプト",
      glassboxSystemPromptDesc: "組み込みの音声システムプロンプトを上書きします。",
      glassboxSystemPromptPlaceholder: "空欄 = 組み込みプロンプトファイルを使用",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
